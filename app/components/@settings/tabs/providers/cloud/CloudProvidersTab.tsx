...
const PROVIDER_ICONS: Record<ProviderName, IconType> = {
  Google: SiGoogle,
  OpenRouter: FaCloud,
  QwenCode: BiCodeBlock,
  GeminiCli: SiGoogle,
};

// Update PROVIDER_DESCRIPTIONS to use the same type
const PROVIDER_DESCRIPTIONS: Partial<Record<ProviderName, string>> = {
  Google: 'Access Gemini models for advanced AI capabilities',
  OpenRouter: 'Access multiple AI models through OpenRouter',
  QwenCode: 'Use Qwen 3 Coder models for advanced coding assistance',
  GeminiCli: 'Use Gemini CLI with OAuth authentication for code assistance',
};
